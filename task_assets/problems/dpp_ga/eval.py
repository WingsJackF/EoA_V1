"""
This file evaluates crossover quality and can be adapted to optimize other operators as well.
"""
...
def evolved_crossover(parents: np.ndarray, n_pop: int) -> np.ndarray:
    """Alternative crossover implementation."""
    n_parents, n_decap = parents.shape
...
def evolved_mutation(population: np.ndarray, probe: int, prohibit: np.ndarray, size: int = 100) -> np.ndarray:
    """Alternative mutation implementation."""
