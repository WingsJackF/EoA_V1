"""演化任务：TSP constructive (next-node heuristic)"""
...
class TspConstructiveTask(EvolutionTask):
    id = TASK_ID
...
def build_tsp_constructive_task() -> TspConstructiveTask:
    return TspConstructiveTask()
